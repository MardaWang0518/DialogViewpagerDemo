...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] imageList = new int[]{R.drawable.other,R.drawable.kobe02,R.drawable.kobe03,R.drawable.kobe04 };
    ...
    private void initview() {
        ...
        mTv_content.setText("什么是曼巴精神？每个人有自己的答案。KobeBryant自己的解读是：passionate、obsessive、relentless" +
